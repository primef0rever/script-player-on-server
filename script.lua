...
-- Контейнер: AnchorPoint(1, 1) ставит точку привязки в правый нижний угол
-- Position(1, -20, 1, -180) смещает его вверх от кнопки прыжка (которая обычно на уровне 150-160 пикселей)
...
local function showNotification(joinedPlayer)
	...
	TweenService:Create(frame, tweenInfo, {Size = UDim2.new(1, 0, 0, 50), BackgroundTransparency = 0.2}):Play()
